...
public class MyLikesActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("我的点赞");
        ...
        adapter.setOnPostClickListener(new PostAdapter.OnPostClickListener() {
            ...
            public void onPostClick(int postId) {
                Intent intent = new Intent(MyLikesActivity.this, PostDetailActivity.class);
        ...
        // 加载点赞列表
        viewModel.loadUserLikes(currentUserId);
